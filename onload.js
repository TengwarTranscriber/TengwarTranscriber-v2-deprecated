$(function(){
      ...
      console.error("I never bothered to fix the two errors involving 'unslider.css', but I did bother to write code that writes error messages explaining the error messages that I can't be bothered to fix.")
